...
def resnet_56(compress_rate, num_classes):
    return ResNet(BasicBlock, 56, compress_rate=compress_rate, num_classes=num_classes)

def resnet_110(compress_rate, num_classes):
    return ResNet(BasicBlock, 110, compress_rate=compress_rate, num_classes=num_classes)